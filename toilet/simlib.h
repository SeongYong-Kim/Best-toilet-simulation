...
extern float weibull(float lambda, float k, float r,int stream);
extern float beta(float a, float b, int stream);
extern float gamma(float a, float b, int stream);
extern float lognormal(float mean, float std, int stream);
extern float generalized_pareto(float k, float sigma, float mu, int stream);
